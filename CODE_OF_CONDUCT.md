...
We as members, contributors, and leaders pledge to make participation in the Quorfix community
...
This Code of Conduct applies within all project spaces (this repository's issues, pull requests,
and discussions), and also applies when an individual is officially representing the project in
public spaces.
...
people involved for a specified period of time, including unsolicited interaction with those
enforcing the Code of Conduct, for that period. Violating these terms may lead to a temporary or
permanent ban.
...
involved is allowed during this period. Violating these terms may lead to a permanent ban.
